...
src_dsts = [
    ...
    },
    {
        ...
        'dsts': [
            'CDT', 'VLC', 'ALC', 'AGP', 'PMI', 'MAD', 'SDR', 'BCN', 'SVQ',  # 'IBZ'-nonExistent
            'LIS', 'TFS',  # 'LPA'-nonExistent,
            'LCA', 'MLA', 'AHO',
            'ZTH', 'JMK', 'JTR', 'HER', 'PVK', 'JSI', 'CFU', 'ATH',
            'PSA', 'FCO', 'CIA', 'NAP', 'QSR',  # 'TRN','MXP','BGY',
            'TRS', 'TSF', 'VCE', 'PSR', 'BRI', 'BDS', 'CTA',  # 'CAM'-nonExistent,
            'NCE',
            'BLL', 'CPH',  # 'AAR'-nonExistent, # DK
            'DTM', 'STR', 'FMM', 'CGN', 'HHN', 'HAM',
            'BUD', 'GDN', 'CRL',
            'BSL',
            'OPO',
            'TRF',
